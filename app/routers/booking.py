...
from app.database.booking import get_booked_seats_query, update_booked_seats_query
from app.database.event import event_exists_query
...
async def get_bookings(event_id: int):
    booked_seats = get_booked_seats_query(event_id)
...
async def add_bookings(event_id: int, booking: Booking):
    ...
    existing_booked_seats = get_booked_seats_query(event_id)
    ...
    update_booked_seats_query(event_id, new_booked_seats)
